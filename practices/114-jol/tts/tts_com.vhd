...
architecture arch of tts_com is
	...
	Components : block begin
		i2c_com : entity work.i2c_master(arch)
			...
			port map(
				...
				addr      => tts_addr,                     --IN		--address of target slave
	...
	process (clk, rst_n) begin
		if rst_n = '0' then
			...
			case mode is
				...
				when awake =>
					if i2c_busy = '0' and i2c_accepted = '0' then
						i2c_data_I <= (x"80");
						i2c_ena <= '1';
					else
						i2c_ena <= '0';
				...
				when set_mo0 =>
					if i2c_busy = '0' and i2c_accepted = '0' and txt_cnt <= 1 then
