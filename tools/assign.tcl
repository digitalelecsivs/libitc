...
# board_1 40Q
	...
	# set_location_assignment PIN_144 -to lcd_sclk 
	# set_location_assignment PIN_143 -to lcd_mosi
	# set_location_assignment PIN_142 -to lcd_rst_n
	# set_location_assignment PIN_139 -to lcd_dc 
	# set_location_assignment PIN_137 -to lcd_ss_n
	# set_location_assignment PIN_135 -to lcd_bl
	# # DATA
	...
	set_location_assignment PIN_107 -to dot_red[7]

	# DOT_R{4,3,2,1,5,6,7,8} (R stands for green)
	set_location_assignment PIN_110  -to dot_green[0]
	...
	set_location_assignment PIN_111  -to dot_green[7]
	...
	# set_location_assignment PIN_184 -to dbg_b[0]
	# set_location_assignment PIN_177 -to dbg_b[1]
	# set_location_assignment PIN_173 -to dbg_b[2]
	# set_location_assignment PIN_169 -to dbg_b[3]
	set_location_assignment PIN_196 -to dbg_a[0]
	set_location_assignment PIN_194 -to dbg_a[1]
	set_location_assignment PIN_188 -to dbg_a[2]
	set_location_assignment PIN_186 -to dbg_a[3]
